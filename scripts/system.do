...
add wave -noupdate -group {Memory Control} /system_tb/DUT/CPU/CC/CLK
add wave -noupdate -group {Memory Control} /system_tb/DUT/CPU/CC/nRST
add wave -noupdate -group {Memory Control} /system_tb/DUT/CPU/CC/state
add wave -noupdate -group {Memory Control} /system_tb/DUT/CPU/CC/nextstate
add wave -noupdate -group {Memory Control} /system_tb/DUT/CPU/CC/snooper
add wave -noupdate -group {Memory Control} /system_tb/DUT/CPU/CC/next_snooper
...
add wave -noupdate -group ccif -radix binary /system_tb/DUT/CPU/ccif/ccwait
add wave -noupdate -group ccif -radix binary /system_tb/DUT/CPU/ccif/ccinv
add wave -noupdate -group ccif -radix binary /system_tb/DUT/CPU/ccif/ccwrite
add wave -noupdate -group ccif -radix binary /system_tb/DUT/CPU/ccif/cctrans
...
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/wb
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/mem
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/ex
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/id
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/flush
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/stall
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/forwardA
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/forwardB
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/wb_enable
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_imemload
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_npc
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_pc
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_RegDst
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_ALUSrc
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_ALUop
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_MemWr
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_beq
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_bne
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_jump
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_jreg
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_jal
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_RegWr
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_MemtoReg
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_Halt
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_rdat1
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_rdat2
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_lui_imm
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_cur_imm
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_jumpAddr
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_branchAddr
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_aluPortB
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_rt
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_rd
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_ALUout
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_zero
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_WrDest
add wave -noupdate -expand -group prif /system_tb/DUT/CPU/DP0/prif/in_dmemload
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1416392 ps} 0}
...
update
WaveRestoreZoom {695 ns} {2085 ns}

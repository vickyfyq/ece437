...
add wave -noupdate -group dcache0 /system_tb/DUT/CPU/CM0/DCACHE/snoop_dirty
...
WaveRestoreCursors {{Cursor 1} {15845680000 ps} 0}
...
update
WaveRestoreZoom {15814854 ns} {15937526 ns}
